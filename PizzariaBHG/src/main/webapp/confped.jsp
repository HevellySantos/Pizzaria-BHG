    ...
    <div class="content">
        ...
        <div class="order-details">
            ...
            <div class="order-item">
                <%= request.getParameter("pizzaSelecionada") != null ? request.getParameter("pizzaSelecionada") : "Pizza Imperiale" %> -
                R$ <%= request.getParameter("precoPizza") != null ? request.getParameter("precoPizza") : "40.00" %> x
                <%= request.getParameter("quantidadePizza") != null ? request.getParameter("quantidadePizza") : "1" %>
            </div>

            <div class="order-item">
                Bebida Selecionada:
                <%= request.getParameter("bebidaSelecionada") != null ? request.getParameter("bebidaSelecionada") : "Suco de Uva 1L" %> -
                R$ <%= request.getParameter("precoBebida") != null ? request.getParameter("precoBebida") : "12.00" %> x
                <%= request.getParameter("quantidadeBebida") != null ? request.getParameter("quantidadeBebida") : "1" %>
            </div>
            ...
            <div class="total">Subtotal: R$ 52,00</div>
            <div class="total">Taxa de entrega: R$ <%= String.format("%.2f", frete) %></div>
            <div class="total">Total: R$ 58,00</div>
        </div>
